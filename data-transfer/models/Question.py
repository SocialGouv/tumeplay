...
class Question:
    ...
    def __init__(self, text_question, text_answer, image_url, theme_id, response_A, response_B, response_C, response_A_neutral, response_B_neutral, response_C_neutral, right_answer):
